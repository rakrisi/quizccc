...
Route::post('/date',function(Request $req){
 ...
 Route::prefix('superadmin')->group(function(){
    ...
    Route::get('/addteacher', 'SuperdminController@Addteacher')->name('addteacher');
    Route::get('/listteacher', 'SuperadminController@showteacher')->name('teacherlist');
});
Route::get('/demo', 'Controller@demo');
Route::post('logout1', 'SuperadminController@Logout');
Route::get('/liststudents', 'SuperadminController@showstudent')->name('studentlist');
Route::post('/liststudents', 'SuperadminController@Addstudent');
Route::get('/addstudent', 'SuperadminController@Addstudent')->name('addstudent');
Route::get('/Examadd', 'SuperadminController@showExams')->name('MyExams');
Route::post('/addexam', 'SuperadminController@Add_Exam');
Route::get('/addquestion/examcode/{id}/{title}/{tname}/{cat}/{time}', 'SuperadminController@addquest');
Route::post('/addquestions', 'SuperadminController@Addquestion');
Route::post('/Addquestiontodb', 'SuperadminController@Addsubject');
Route::post('/updatequestion', 'SuperadminController@updatequestion');
Route::post('/QuestionRandom', 'SuperadminController@QuestionRandom');
Route::get('/StudentResults', 'SuperadminController@StudentResults');
Route::get('/comingsoonadd', 'SuperadminController@comingsoonadd');
Route::get('/listadmins', 'SuperadminController@showadmin')->name('adminlist');