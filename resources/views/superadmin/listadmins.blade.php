                                                    ...
                                                    @foreach ($admins as $value)
                                                        <tr class="student{{$value->id}}">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a onclick="viewdetil( '{{ $value->name }}','{{ $value->id }}', '{{Auth::user()->id}}','{{ $value->created_at }}','{{ $value->validity }}' )" href="#" class="show-modal btn btn-info btn-sm" data-id="{{ $value->id }}" data-name="{{ $value->name }}" data-id ="{{ $value->id }}">
                                                                <i class="icofont icofont-eye-alt"></i>
                                                                </a>
                                                                <a onclick="Editdetail( '{{ $value->id }}','{{ $value->name }}','{{ $value->id }}' )" href="#" class="edit-modal btn btn-warning btn-sm" data-id="{{ $value->id }}" data-name="{{ $value->name }}" data-id ="{{ $value->id }}">
                                                                    <i class="glyphicon glyphicon-pencil"></i>
                                                                </a>
                                                                <a onclick="Delete_user( '{{ $value->id }}','{{ $value->name }}','{{ $value->id }}' )" href="#" class="detete-modal btn btn-danger btn-sm" data-id="{{ $value->id }}" data-name="{{ $value->name }}" data-id ="{{ $value->id }}">
                                                ...
                                                <div class="modal-body"> 
                                                    ...
                                                    <form class="form-horizontal" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-4" for="id">Create Student Id :</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control" id="id" name="id" placeholder="Enter Student Id" required>
                                                                <p class="id_error text-center alert alert-danger hidden"></p>
                                                            </div>
                                                        </div>
                                      ...
                                      <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="margin: 0px auto;">
                                                    ...
                                                    <p class="text-primary">Student Id :<span id = "view_id"></span>  </p>
                                      ...
                                      <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" style="margin: 0px auto;">
                                                    ...
                                                    <p class="text-primary">Student Id :<span id = "delete_id"></span>  </p>
                                                    <div class="modal-footer">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-4" for="id">Student Id :</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" disabled class="form-control" id="uid" name="uid" placeholder="Enter Student Id" required>
                                                                <p class="id_error text-center alert alert-danger hidden"></p>
                                                            </div>
                                                        </div>
